...
$(document).ready(function() {
	...
	$('#grid-view').click(function() {
		...
		if (cols == 2) {
			//отключил стиль module-style1 чтобы не было hover
			$('#content .product-layout').attr('class', 'product-layout product-grid module-style1-off col-md-6 col-sm-6 col-xs-6 two-items');
		} else if (cols == 1) {
			$('#content .product-layout').attr('class', 'product-layout product-grid module-style1-off col-md-4 col-sm-6 col-xs-6 three-items');
		} else {
			$('#content .product-layout').attr('class', 'product-layout product-grid module-style1-off col-md-3 col-sm-6 col-xs-6 four-items');
		}
