...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		if ($product_info) {
            ...
            $seo_text_str =  $product_info['meta_keyword'];
			if (strlen($seo_text_str) > 0) {
                $seo_text_str = str_replace('&lt;br&gt;', '<br>', $seo_text_str).'.';
                $seo_text_arr = explode('<br>',$seo_text_str,2);
                $data['keyword_text_h'] = $seo_text_arr[0];
                $data['keyword_text'] = $seo_text_arr[1];
            }
